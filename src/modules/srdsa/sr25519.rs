...
pub fn sr_sign_sr25519(secret_key: Vec<u8>, message: Vec<u8>) -> Result<Vec<u8>, String> {

    let mini_secret_key = schnorrkel::MiniSecretKey::from_bytes(&secret_key).map_err(|_| "Invalid secret key")?;
...
pub fn sr_pk_sr25519(secret_key: Vec<u8>) -> Result<Vec<u8>, String> {
    ...
    vec![
        ...
        ("sr_sign",
         vec![
             Case {
                 desc: "".to_string(),
                 input: vec!["-s", "0xc243239f434f7a4b0ab8d4600537001e6479c807c3d3623f99c8ad9f2a588837", "0x616263"].into_iter().map(Into::into).collect(),
        ...
        ("sr_pk",
         vec![
             Case {
                 desc: "".to_string(),
                 input: vec!["-s", "0xc243239f434f7a4b0ab8d4600537001e6479c807c3d3623f99c8ad9f2a588837"].into_iter().map(Into::into).collect(),
